...
<head>
    ...
    <meta name="author" content="Chavan Balaji">
...
<body>
    <div id="progress"></div>
    <!-- Navigation -->
    <nav class="navbar mnav navbar-expand-lg navbar-dark static-top" style="background-color: #2C5364;padding:20px;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        <div class="container" style="font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
            <a style="margin-left:0%;padding-left:0px" class="navbar-brand" href="https://www.mgmccsit.ac.in/">
                <h3 class="mh3">MGM's<br/><p style = "margin-left:0%;font-size:12px;margin-top:0;position:absolute;top:60px">College of Computer Science & Information Technology, Nanded.<br/></p></h3>
            </a>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <select name="dept" class="select1" autocomplete="off" placeholder="computer science" required>
                            ...
                            <option name="s1"> Computer Science & IT</option>
