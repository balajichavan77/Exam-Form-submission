...
if (!$rr) {
    $exerrr = "<font color='red';font-family:'Acme';></font>";
} else {
    $exerrr = "<font color='primary'></font>";
}
...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" style="position:fixed;top:0;left:0;padding:8px;border:none;background-color:#2C5364;border-bottom:1px solid black;box-shadow: 3px 3px 5px black;">
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s4">
            <ul>
                ...
                <li><a href="dashboard.php?page=exam_form1"><i class="fas fa-pen"></i>Exam Form</a></li>
   ...
   if($con->query($sql) === TRUE)
   {
    ...
    else
    {
       ...
       exit();
                ...
                if ($page == "exam_form1") {
                    include('exam_form1.php');
                    include('examformtry.php');
                }
                

            } else {
            ?><h2 style="font-family:'Bitter';margin-left: 2%;font-weight:6 0;"><?php echo @$exerrr; ?></h2>
