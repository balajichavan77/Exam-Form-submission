...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: #2C5364;    border-top: 2px solid black;}
    ...
    /* Copy Right Footer */
    .footer-copyright {	background-color: #2C5364;	padding: 5px 0;box-shadow: -1px -1px 3px black;border-top:1px solid black;}
...
<footer style = "font-size : 18px;" id="footer" class="footer-1">
    ...
    <h2 class="widget-title mylink" style = "font-family:Acme;"><b><a href = "https://www.mgmccsit.ac.in/">MGM's</a></b></h2>
    <p style="color:#fff;"><i class="fa fa-map-marker-alt" aria-hidden="true" style = "font-size:15px;color:#fff;"></i>  Address:
    Namaskar Chowk, Near Airport Road,
    Nanded - 431605
    Maharashtra, India.</p>
    </div>
    </div>
    ...
    <li>
    <div class="thumb-content"><a href="https://www.mgmccsit.ac.in/About_mgm.htm">About MGM's</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://www.mgmccsit.ac.in/academics.htm">Academic Calender</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://mgmu.ac.in/examinations/#results">Results</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://www.mgmccsit.ac.in/csit%20staff.htm">Faculty</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="https://www.mgmccsit.ac.in/Placements%20&%20Training%20Cell.htm">Training & Placement Cell</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a  href="https://www.mgmccsit.ac.in/Contact_Us.htm" target="_blank">Contact Us</a></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <li><a  href="https://www.mgmccsit.ac.in/cs%20department.htm" target="_blank">CS & IT Department</a></li>
    <li><a  href="https://www.mgmccsit.ac.in/biotech%20department.htm" target="_blank">BT & BI Department</a></li>
    <li><a  href="https://www.mgmccsit.ac.in/Electronics.htm" target="_blank">Electronics Department</a></li>
    <li><a  href="https://www.mgmccsit.ac.in/Cultural%20Activities.htm" target="_blank">Cultural Activities</a></li>
    <li><a  href="https://www.mgmccsit.ac.in/events.htm" target="_blank">Events & Festivals</a></li>
    <li><a  href="https://www.mgmccsit.ac.in/About_College.htm" target="_blank">About College</a></li>
    </ul>
    </div>
    </div>
    ...
    <p style = "font-family:'PT serif';color:white;">© MGM's College of CS & IT, Nanded.</p>
    </div>
    </div>
    </div>
    </div>
