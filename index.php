...
<body>
    <div id="progress"></div>
    <nav class="navbar navbar-light" style="background-color: #2C5364;margin-bottom:2%;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        <a class="mh3 navbar-brand text-white" style="font-family:'Acme';font-size:30px" href="https://www.mgmccsit.ac.in/">MGM's<br/><p style = "margin-left:0%;font-size:12px;margin-top:0;position:absolute;top:50px">College of Computer Science & Information Technology, Nanded.<br/></p></a>
