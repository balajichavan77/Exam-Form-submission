...
<head>
    ...
    <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #2C5364; border-bottom:1px solid black;box-shadow: 3px 3px 5px;">
            <div class="container" style = "font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
                <a class="navbar-brand" href="https://www.mgmccsit.ac.in/">
                    <h3 style = "font-family:'PT Serif';" ><img src="css/images/logo.png" width="70" style = "border-radius:50%;border:1px black;background-color:white;" height="70" alt="MGM's"/> <span class = "mh3">MGM's</span><br/><p style = "margin-left:6%;font-size:12px;margin-top:0;position:absolute;top:60px">College of Computer Science & Information Technology, Nanded.<br/></p></h3>
                </a>
