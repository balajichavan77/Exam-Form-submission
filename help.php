...
<body>
   <div id="progress"></div>
   <nav class="navbar navbar-light" style = "background-color: #2C5364;margin-bottom:2%;box-shadow: 3px 3px 5px;border-bottom:3px solid black;">
      <a class="navbar-brand text-white" style = "font-family:'Acme';font-size:30px" href="https://www.mgmccsit.ac.in/">MGM's<br/><p style = "margin-left:0%;font-size:12px;margin-top:0;position:absolute;top:50px">College of Computer Science & Information Technology, Nanded.<br/></p></a>
   ...
   <div class = "col-lg-6 m-auto mcon" style = "border-radius: none;">
      ...
      <h4 style = "text-shadow: 0.5px 0.5px black;padding-right: 10px;"> NOTE: CANNOT REGISTER FOR BACK-LOG EXAM BEFORE SEE</h4>
            <p style = "text-shadow: 0.5px 0.5px black;padding-right: 10px;margin-bottom:0%;">LINK FOR BACL-LOG WILL BE AVAILABLE IN JUNE 2022 (After Even Sem)</p><br/>
      <br/>
   </div>
   <!--Scroll Up js File-->
